...
-----------------------------
Randomly reducing the dataset to a fraction of its original size and
...
def ablation_testing(model_dict,
                     landscape_dict,
                     split=0.8,
                     cross_validation=1,
                     save=True,
    ...
    complete_results = {x: {key :0 for key in landscape_dict.keys()} for x in model_dict.keys()}
